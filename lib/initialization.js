...
function programConfig() {
  ...
  program
    .command("test <name>")
    .description("tgo-cli in travis-ci test")
      ...
      switch (name) {
        case "bs":
          ...
          store.options.dependencies = [
            ...store.options.dependencies,
            ...store.dependencies.eslint
          ];
          store.options.dependencies = [
            ...store.options.dependencies,
            ...store.dependencies.babel
          ];
          break;
        case "mobileLayout":
          ...
          store.options.dependencies = [
            ...store.options.dependencies,
            ...store.dependencies.mobileLayout
          ];
          break;
        case "sass":
